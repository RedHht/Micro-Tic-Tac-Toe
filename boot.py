...
def crear_ap(essid, password, max_clientes):
    ...
    ap_if.config(essid=essid, password=password, max_clients=max_clientes) # configura los parámetros de la red
    return ap_if # devuelve el objeto -ap_if-



crear_ap("Tic-Tac-Toe", "tecnica32023", 3)
webrepl.start()